...
import 'package:demo1/pages/testing_page/initial_page.dart';
...
class BottomBar extends StatefulWidget {
  ...
  const BottomBar({
    ...
    required this.end,
    required this.start,
    required this.onPageChanged, // Callback function parameter
    Key? key,
  }) : super(key: key);
                      ...
                      onTap: (index) {
                        ...
                        setState(() {
                          ...
                          print(index.toString() +
                              'this is index of current index on BOTTOM BAR ');
                        }); // Update current page
                      },
                      tabs: [
                        SizedBox(
